...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2020 at 05:05 AM
...
INSERT INTO `contrato` (`id`, `id_locatario`, `id_locador`, `id_imovel`, `data_inicio`, `data_fim`, `taxa_administrativa`, `valor_aluguel`, `valor_condominio`, `valor_iptu`) VALUES
(1, 1, 1, 1, '2020-12-11', NULL, 100, 100, 100, 100);
...
INSERT INTO `imovel` (`id`, `id_proprietario`, `cep`, `logradouro`, `complemento`, `bairro`, `cidade`, `uf`) VALUES
(1, 1, '49001-356', 'Rua B', 'test', 'Zona de Expansão (Aruana)', 'test', 'SC');
...
INSERT INTO `locador` (`id`, `nome`, `email`, `telefone`) VALUES
(1, 'dj123', '123@gmail.com', '(82) 9 9833-3377');
...
INSERT INTO `locatario` (`id`, `nome`, `email`, `telefone`) VALUES
(1, 'teste santos', 'teste@gmailcom', '(82) 9 9833-3377');
...
INSERT INTO `mensalidade` (`id`, `indice`, `id_contrato`, `valor_mensalidade`, `status`, `data`) VALUES
(1, 0, 1, 300, 'EM ABERTO', '2021-01-11'),
(2, 1, 1, 300, 'EM ABERTO', '2021-02-11');
...
INSERT INTO `repasse` (`id`, `indice`, `id_contrato`, `valor_repasse`, `status`, `data`) VALUES
(1, 0, 1, 100, 'EM ABERTO', '2021-01-16'),
(2, 1, 1, 100, 'EM ABERTO', '2021-02-16');
